...
export const DEFAULT_CONTENT = {
  ...
  interSegments: [
    ...
    { id: "Murder Mystery", name: "Murder Mystery", tagline: "Deduce clues and crack mathematical murder mystery cases.", category: "Solo track", icon: "Eye", isTeamEvent: false, teamSize: 1, isFree: false, bannerUrl: "https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?auto=format&fit=crop&w=1200&q=80", description: "Channel your inner mathematical detective! Use cryptanalysis, logic grids, and probability elimination to solve a fictional crime scene case." },
    ...
    { id: "Wall Magazine Display", name: "Wall Magazine Display", tagline: "Design an informative physical wall poster/magazine.", category: "Exhibition track", icon: "Layout", isTeamEvent: false, teamSize: 1, isFree: false, bannerUrl: "https://images.unsplash.com/photo-1526721940322-10fb6e3ae94a?auto=format&fit=crop&w=1200&q=80", description: "Design an informative, visually captivating physical wall poster/magazine showcasing mathematical discoveries, history, or modern research." }
  ],
  festivalCalendar: {
