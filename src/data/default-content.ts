...
export const DEFAULT_CONTENT = {
  ...
  interSegments: [
    { id: "Math Olympiad (Find-based)", name: "Math Olympiad (Find-based)", tagline: "Solve numeric mysteries and discover deep hidden structural patterns.", category: "Solo track", icon: "Trophy", isTeamEvent: false, teamSize: 1, isFree: true, allowedCategories: ["Primary", "Junior", "Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&w=1200&q=80", description: "Test your numeric intuition and mathematical pattern recognition under time constraints. Find exact numerical values without writing long proofs." },
    { id: "Math Olympiad (Proof-based)", name: "Math Olympiad (Proof-based)", tagline: "Draft elegant formal proofs and logically sound explanations.", category: "Solo track", icon: "FileText", isTeamEvent: false, teamSize: 1, isFree: true, allowedCategories: ["Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&w=1200&q=80", description: "Demonstrate rigorous logical deduction and mathematical elegance by constructing full formal proofs across geometry, number theory, and algebra." },
    { id: "IQ Test", name: "IQ Test", tagline: "Race against the clock in analytical speed reasoning.", category: "Solo track", icon: "Brain", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Primary", "Junior", "Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80", description: "A rapid-fire series of spatial, visual, and analytical logic puzzles designed to evaluate fluid intelligence and cognitive processing speed." },
    { id: "Human Calculator", name: "Human Calculator", tagline: "Unleash super-speed mental arithmetic and calculation loops.", category: "Solo track", icon: "Zap", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Primary", "Junior"], bannerUrl: "https://images.unsplash.com/photo-1596495578065-6e0763fa1178?auto=format&fit=crop&w=1200&q=80", description: "Battle time and mental fatigue in rapid mental math playoffs! Calculate complex multiplications, square roots, and percentages without scratch paper." },
    { id: "Genesis", name: "Genesis", tagline: "Interactive math design and scientific origin-based discovery.", category: "Solo track", icon: "Sparkles", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Primary", "Junior", "Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1200&q=80", description: "Explore the origin stories of fundamental mathematical constants, geometric theorems, and historical mathematical breakthroughs." },
    { id: "Geometry Dash", name: "Geometry Dash", tagline: "Navigate space calculations, angle proofs, and vector mazes.", category: "Solo track", icon: "Compass", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1509228627152-72ae946807b1?auto=format&fit=crop&w=1200&q=80", description: "Navigate spatial reasoning, coordinate plane geometry, circle theorems, and 3D vector geometry problems in a high-octane quiz format." },
    { id: "Probability Pressure", name: "Probability Pressure", tagline: "Calculate rapid-fire odds and stochastic outcomes under stress.", category: "Solo track", icon: "Timer", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1518609878373-06d740f60d8b?auto=format&fit=crop&w=1200&q=80", description: "Calculate odds, permutations, combinations, and conditional probabilities under intense countdown timer pressure." },
    { id: "Murder Mystery", name: "Murder Mystery", tagline: "Deduce clues and crack mathematical murder mystery cases.", category: "Solo track", icon: "Eye", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Primary", "Junior", "Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?auto=format&fit=crop&w=1200&q=80", description: "Channel your inner mathematical detective! Use cryptanalysis, logic grids, and probability elimination to solve a fictional crime scene case." },
    { id: "Crack the Code", name: "Crack the Code", tagline: "Deconstruct cryptographic ciphers and decode encrypted strings.", category: "Solo track", icon: "Lock", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Primary", "Junior", "Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=1200&q=80", description: "Decrypt complex ciphers, frequency analysis substitution puzzles, binary strings, and modular arithmetic cryptography." },
    { id: "Complex Calamity", name: "Complex Calamity", tagline: "Grapple with complex numbers, imaginary axes, and fractals.", category: "Solo track", icon: "HelpCircle", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1509228468518-180dd4864904?auto=format&fit=crop&w=1200&q=80", description: "A specialized solo challenge tackling imaginary axes, Euler's formula, polar coordinates, and complex plane transformations." },
    { id: "Sudoku", name: "Sudoku", tagline: "Solve grid placement challenges with extreme speed precision.", category: "Solo track", icon: "Grid", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Primary", "Junior", "Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=1200&q=80", description: "Compete in speed-solving custom high-difficulty Sudoku grids, testing spatial placement and structural constraint solving." },
    { id: "Rubik’s Cube Showdown", name: "Rubik’s Cube Showdown", tagline: "Manipulate cubic modules and solve cubes in record times.", category: "Solo track", icon: "Layers", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Primary", "Junior", "Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1563089145-599997674d42?auto=format&fit=crop&w=1200&q=80", description: "Speedcubing tournament for 3x3, 4x4, and custom puzzle cubes. Speed, finger tricks, and algorithmic muscle memory win the day." },
    { id: "5 min Professor", name: "5 min Professor", tagline: "Deliver a lightning lecture explaining abstract concepts simply.", category: "Solo track", icon: "Award", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=1200&q=80", description: "Prepare and deliver a 5-minute concise presentation explaining an advanced or abstract mathematical topic to a panel of judges." },
    { id: "Calculus Bee", name: "Calculus Bee", tagline: "Solve derivatives and integral equations in real-time playoffs.", category: "Solo track", icon: "Activity", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&w=1200&q=80", description: "Live playoff competition calculating derivatives, definite integrals, differential equations, and limits on a whiteboard." },
    ...
    { id: "Math Drawing", name: "Math Drawing", tagline: "Hand-drawn artistic competition.", category: "Solo track", icon: "Edit", isTeamEvent: false, teamSize: 1, isFree: false, allowedCategories: ["Primary", "Junior", "Secondary", "Higher Secondary"], bannerUrl: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?auto=format&fit=crop&w=1200&q=80", description: "Hand-drawn artistic competition. Sketch pristine artwork illustrating mathematical concepts, tessellations, or non-Euclidean geometry." }
  ],
  festivalCalendar: {
