...
export const Hero: React.FC<HeroProps> = ({ home, shouldReduceGfx }) => {
  ...
  return (
    <section 
      id="hero" 
      ref={containerRef}
      className="relative pt-24 pb-28 md:pt-36 md:pb-40 overflow-hidden border-b border-white/[0.05] perspective-2000 premium-3d-bg"
      style={{
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center relative z-10">
          <motion.div
            ...
            className="inline-flex items-center gap-3 px-6 py-2 mb-6 rounded-full glass border-white/10 shadow-2xl relative hud-bracket hud-bracket-tl hud-bracket-br overflow-hidden group"
          >
          ...
          <div className="mb-6 relative group">
            ...
            <h1 className="text-[12vw] sm:text-[10vw] md:text-[7.5vw] lg:text-[5.2vw] font-bold tracking-[-0.05em] text-white font-display leading-[1.05] sm:leading-[1.05] flex flex-col items-center select-none break-words max-w-full overflow-hidden px-2">
          ...
          <motion.p
            ...
            className="text-base sm:text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto mb-10 md:mb-12 leading-relaxed font-light tracking-wide italic font-serif px-4"
          >
            {shouldReduceGfx ? (
