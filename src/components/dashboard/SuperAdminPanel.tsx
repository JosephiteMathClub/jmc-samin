        ...
        const sanitizeSegs = (segs: any[]) => {
          ...
          return segs.map((s) => {
            ...
            if (norm.includes('murder mystery') || norm.includes('wall magazine')) {
              ...
              return { ...s, isTeamEvent: false, teamSize: 1, category, allowedCategories };
            }
            if (norm.includes('escape room') || norm.includes('truss')) {
              return { ...s, isTeamEvent: true, teamSize: s.teamSize || 3, category: s.category || 'Team track', allowedCategories };
            }
            return { ...s, allowedCategories };
          });
        };
                            ...
                            return (
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  handleUpdateSegment(idx, 'allowedCategories', nextList);
                                }}
